...
public class Fourteenth extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Thread next=new Thread(){
			public void run(){
				try{
					...
					Intent nextActivity= new Intent(Fourteenth.this,Fifteenth.class);
		...
		scramble.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent shuffle =new Intent(Fourteenth.this,Fourteenth.class);
