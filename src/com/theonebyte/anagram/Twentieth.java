...
public class Twentieth extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.twentieth);
		...
		final String word="communication";
		final char[] array;
		array=new char[13];
		int j;
		...
		final Thread next=new Thread(){
			public void run(){
				try{
					...
					Intent nextActivity= new Intent(Twentieth.this,End.class);
		...
		scramble.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent shuffle =new Intent(Twentieth.this,Twentieth.class);
