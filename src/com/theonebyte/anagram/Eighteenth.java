...
public class Eighteenth extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.eighteenth);
		...
		final Thread next=new Thread(){
			public void run(){
				try{
					...
					Intent nextActivity= new Intent(Eighteenth.this,Ninteenth.class);
		...
		scramble.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent shuffle =new Intent(Eighteenth.this,Eighteenth.class);
