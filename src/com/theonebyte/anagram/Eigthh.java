...
public class Eigthh extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final Thread next=new Thread(){
			public void run(){
				try{
					...
					Intent nextActivity= new Intent(Eigthh.this,Ninth.class);
		...
		scramble.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent shuffle =new Intent(Eigthh.this,Eigthh.class);
